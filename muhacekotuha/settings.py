"""
Django settings for muhacekotuha project.
...
DEBUG = os.getenv('DJANGO_DEBG', '') and False
...
ROOT_URLCONF = 'muhacekotuha.urls'
...
WSGI_APPLICATION = 'muhacekotuha.wsgi.application'
