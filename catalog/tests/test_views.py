...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        login = self.client.login(username='testuser2', password='12345')
        test_author = Author.objects.create(first_name="John", last_name="Brown", date_of_birth="1900-10-10", date_of_death="2000-7-6")
        resp = self.client.post(reverse('author_create'), {"first_name" : "John", 'last_name' : "Brown", "date_of_birth" : "1900-10-10", "date_of_death" :"2000-7-6"})
        self.assertRedirects(resp, reverse('author-detail', args=[str(2)]) )
